@extends('layouts.app',['page' => __('Edit Character'), 'pageSlug' => 'character'])
    ...
    <form action="{{ route('character.update', $character) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Race</label>
                    <input type="text" name="race" class="form-control" value="{{ $character->race }}" required>
                </div>
                <div class="form-group">
                    <label>Class</label>
                    <input type="text" name="class" class="form-control" value="{{ $character->class }}" required>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Speed</label>
                    <input type="number" name="speed" class="form-control" value="{{ $character->speed }}">
                </div>
                <div class="form-group">
                    <label>Hit Dice</label>
                    <input type="number" name="hit_dice" class="form-control" value="{{ $character->hit_dice }}">
                </div>
                
                <button type="submit" class="btn btn-primary mt-4">Update Character</button>
            </div>
        </div>
    </form>
</div>
